...
export const REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR = new Uint8Array([
  26, 82, 102, 152, 240, 74, 105, 26,
]);

export function getRemoveLiquidityByRangeDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR
  );
}

export type RemoveLiquidityByRangeInstruction<
...
export type RemoveLiquidityByRangeInstructionData = {
...
export type RemoveLiquidityByRangeInstructionDataArgs = {
  fromBinId: number;
  toBinId: number;
  bpsToRemove: number;
};

export function getRemoveLiquidityByRangeInstructionDataEncoder(): FixedSizeEncoder<RemoveLiquidityByRangeInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: REMOVE_LIQUIDITY_BY_RANGE_DISCRIMINATOR,
    })
  );
}

export function getRemoveLiquidityByRangeInstructionDataDecoder(): FixedSizeDecoder<RemoveLiquidityByRangeInstructionData> {
...
export function getRemoveLiquidityByRangeInstructionDataCodec(): FixedSizeCodec<
  RemoveLiquidityByRangeInstructionDataArgs,
  RemoveLiquidityByRangeInstructionData
> {
  return combineCodec(
    getRemoveLiquidityByRangeInstructionDataEncoder(),
    getRemoveLiquidityByRangeInstructionDataDecoder()
  );
}

export type RemoveLiquidityByRangeInput<
...
> = {
  ...
  fromBinId: RemoveLiquidityByRangeInstructionDataArgs['fromBinId'];
  toBinId: RemoveLiquidityByRangeInstructionDataArgs['toBinId'];
  bpsToRemove: RemoveLiquidityByRangeInstructionDataArgs['bpsToRemove'];
};

export function getRemoveLiquidityByRangeInstruction<
  TAccountPosition extends string,
  TAccountLbPair extends string,
  TAccountBinArrayBitmapExtension extends string,
  TAccountUserTokenX extends string,
...
>(
  input: RemoveLiquidityByRangeInput<
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountUserTokenX,
...
> {
  ...
  return Object.freeze({
    ...
    data: getRemoveLiquidityByRangeInstructionDataEncoder().encode(
      args as RemoveLiquidityByRangeInstructionDataArgs
    ),
    programAddress,
  } as RemoveLiquidityByRangeInstruction<
    TProgramAddress,
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
...
export type ParsedRemoveLiquidityByRangeInstruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: RemoveLiquidityByRangeInstructionData;
};

export function parseRemoveLiquidityByRangeInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRemoveLiquidityByRangeInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRemoveLiquidityByRangeInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
