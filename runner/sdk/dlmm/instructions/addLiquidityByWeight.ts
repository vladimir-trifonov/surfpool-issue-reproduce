...
import {
  getBinLiquidityDistributionByWeightDecoder,
  getBinLiquidityDistributionByWeightEncoder,
  type BinLiquidityDistributionByWeight,
  type BinLiquidityDistributionByWeightArgs,
} from '../types';

export const ADD_LIQUIDITY_BY_WEIGHT_DISCRIMINATOR = new Uint8Array([
  28, 140, 238, 99, 231, 162, 21, 149,
]);

export function getAddLiquidityByWeightDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ADD_LIQUIDITY_BY_WEIGHT_DISCRIMINATOR
  );
}

export type AddLiquidityByWeightInstruction<
...
export type AddLiquidityByWeightInstructionData = {
...
export function getAddLiquidityByWeightInstructionDataEncoder(): Encoder<AddLiquidityByWeightInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      [
        'binLiquidityDist',
        getArrayEncoder(getBinLiquidityDistributionByWeightEncoder()),
      ],
    ]),
    (value) => ({
      ...value,
      discriminator: ADD_LIQUIDITY_BY_WEIGHT_DISCRIMINATOR,
    })
  );
}
...
export function getAddLiquidityByWeightInstructionDataDecoder(): Decoder<AddLiquidityByWeightInstructionData> {
  return getStructDecoder([
    ...
    [
      'binLiquidityDist',
      getArrayDecoder(getBinLiquidityDistributionByWeightDecoder()),
    ],
  ]);
}

export function getAddLiquidityByWeightInstructionDataCodec(): Codec<
  AddLiquidityByWeightInstructionDataArgs,
  AddLiquidityByWeightInstructionData
> {
  return combineCodec(
    getAddLiquidityByWeightInstructionDataEncoder(),
    getAddLiquidityByWeightInstructionDataDecoder()
  );
}

export type AddLiquidityByWeightInput<
...
export function getAddLiquidityByWeightInstruction<
  TAccountPosition extends string,
  TAccountLbPair extends string,
  TAccountBinArrayBitmapExtension extends string,
  TAccountUserTokenX extends string,
...
>(
  input: AddLiquidityByWeightInput<
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountUserTokenX,
...
> {
  ...
  return Object.freeze({
    ...
    data: getAddLiquidityByWeightInstructionDataEncoder().encode(
      args as AddLiquidityByWeightInstructionDataArgs
    ),
    programAddress,
  } as AddLiquidityByWeightInstruction<
    TProgramAddress,
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
...
export type ParsedAddLiquidityByWeightInstruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
export function parseAddLiquidityByWeightInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAddLiquidityByWeightInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAddLiquidityByWeightInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
