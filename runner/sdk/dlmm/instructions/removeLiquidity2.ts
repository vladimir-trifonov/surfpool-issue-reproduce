...
import {
  getBinLiquidityReductionDecoder,
  getBinLiquidityReductionEncoder,
  getRemainingAccountsInfoDecoder,
  getRemainingAccountsInfoEncoder,
  type BinLiquidityReduction,
  type BinLiquidityReductionArgs,
...
export type RemoveLiquidity2InstructionDataArgs = {
  binLiquidityRemoval: Array<BinLiquidityReductionArgs>;
  remainingAccountsInfo: RemainingAccountsInfoArgs;
};

export function getRemoveLiquidity2InstructionDataEncoder(): Encoder<RemoveLiquidity2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      [
        'binLiquidityRemoval',
        getArrayEncoder(getBinLiquidityReductionEncoder()),
      ],
...
export function getRemoveLiquidity2InstructionDataDecoder(): Decoder<RemoveLiquidity2InstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
    ['binLiquidityRemoval', getArrayDecoder(getBinLiquidityReductionDecoder())],
    ['remainingAccountsInfo', getRemainingAccountsInfoDecoder()],
  ]);
}

export function getRemoveLiquidity2InstructionDataCodec(): Codec<
...
> = {
  ...
  binLiquidityRemoval: RemoveLiquidity2InstructionDataArgs['binLiquidityRemoval'];
  remainingAccountsInfo: RemoveLiquidity2InstructionDataArgs['remainingAccountsInfo'];
};
