...
export const REMOVE_ALL_LIQUIDITY_DISCRIMINATOR = new Uint8Array([
  10, 51, 61, 35, 112, 105, 24, 85,
]);

export function getRemoveAllLiquidityDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REMOVE_ALL_LIQUIDITY_DISCRIMINATOR
  );
}

export type RemoveAllLiquidityInstruction<
...
export function getRemoveAllLiquidityInstructionDataEncoder(): FixedSizeEncoder<RemoveAllLiquidityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REMOVE_ALL_LIQUIDITY_DISCRIMINATOR })
  );
}

export function getRemoveAllLiquidityInstructionDataDecoder(): FixedSizeDecoder<RemoveAllLiquidityInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getRemoveAllLiquidityInstructionDataCodec(): FixedSizeCodec<
...
> {
  ...
  return Object.freeze({
    ...
    programAddress,
  } as RemoveAllLiquidityInstruction<
    TProgramAddress,
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedRemoveAllLiquidityInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRemoveAllLiquidityInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
