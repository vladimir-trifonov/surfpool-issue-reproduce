...
export const INITIALIZE_POSITION_DISCRIMINATOR = new Uint8Array([
  219, 192, 234, 71, 190, 191, 102, 80,
]);

export function getInitializePositionDiscriminatorBytes() {
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountPosition extends string
        ? WritableSignerAccount<TAccountPosition> &
            AccountSignerMeta<TAccountPosition>
        : TAccountPosition,
...
export function getInitializePositionInstructionDataEncoder(): FixedSizeEncoder<InitializePositionInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: INITIALIZE_POSITION_DISCRIMINATOR })
  );
}
...
export type InitializePositionInput<
...
export function getInitializePositionInstruction<
  TAccountPayer extends string,
  TAccountPosition extends string,
  TAccountLbPair extends string,
  TAccountOwner extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getInitializePositionInstructionDataEncoder().encode(
      args as InitializePositionInstructionDataArgs
    ),
    programAddress,
  } as InitializePositionInstruction<
    TProgramAddress,
    TAccountPayer,
    TAccountPosition,
    TAccountLbPair,
...
>(
  ...
  return {
    ...
    data: getInitializePositionInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
