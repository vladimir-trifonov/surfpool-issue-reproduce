...
export const SWAP_EXACT_OUT2_DISCRIMINATOR = new Uint8Array([
  43, 215, 247, 132, 137, 60, 243, 81,
]);

export function getSwapExactOut2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    SWAP_EXACT_OUT2_DISCRIMINATOR
  );
}

export type SwapExactOut2Instruction<
...
export type SwapExactOut2InstructionData = {
...
export type SwapExactOut2InstructionDataArgs = {
  maxInAmount: number | bigint;
  outAmount: number | bigint;
  remainingAccountsInfo: RemainingAccountsInfoArgs;
};

export function getSwapExactOut2InstructionDataEncoder(): Encoder<SwapExactOut2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['maxInAmount', getU64Encoder()],
      ['outAmount', getU64Encoder()],
      ['remainingAccountsInfo', getRemainingAccountsInfoEncoder()],
    ]),
    (value) => ({ ...value, discriminator: SWAP_EXACT_OUT2_DISCRIMINATOR })
  );
}

export function getSwapExactOut2InstructionDataDecoder(): Decoder<SwapExactOut2InstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
    ['maxInAmount', getU64Decoder()],
    ['outAmount', getU64Decoder()],
    ['remainingAccountsInfo', getRemainingAccountsInfoDecoder()],
  ]);
}

export function getSwapExactOut2InstructionDataCodec(): Codec<
  SwapExactOut2InstructionDataArgs,
  SwapExactOut2InstructionData
> {
  return combineCodec(
    getSwapExactOut2InstructionDataEncoder(),
    getSwapExactOut2InstructionDataDecoder()
  );
}

export type SwapExactOut2Input<
...
> = {
  ...
  maxInAmount: SwapExactOut2InstructionDataArgs['maxInAmount'];
  outAmount: SwapExactOut2InstructionDataArgs['outAmount'];
  remainingAccountsInfo: SwapExactOut2InstructionDataArgs['remainingAccountsInfo'];
};

export function getSwapExactOut2Instruction<
  TAccountLbPair extends string,
  TAccountBinArrayBitmapExtension extends string,
  TAccountReserveX extends string,
  TAccountReserveY extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getSwapExactOut2InstructionDataEncoder().encode(
      args as SwapExactOut2InstructionDataArgs
    ),
    programAddress,
  } as SwapExactOut2Instruction<
    TProgramAddress,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountReserveX,
...
export type ParsedSwapExactOut2Instruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: SwapExactOut2InstructionData;
};

export function parseSwapExactOut2Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedSwapExactOut2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getSwapExactOut2InstructionDataDecoder().decode(instruction.data),
  };
}
