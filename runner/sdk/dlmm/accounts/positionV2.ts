...
export const POSITION_V2_DISCRIMINATOR = new Uint8Array([
  117, 176, 212, 199, 245, 180, 133, 182,
]);

export function getPositionV2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(POSITION_V2_DISCRIMINATOR);
}
...
export function getPositionV2Encoder(): FixedSizeEncoder<PositionV2Args> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['liquidityShares', getArrayEncoder(getU128Encoder(), { size: 70 })],
      [
        'rewardInfos',
      ...
      ['reserved', fixEncoderSize(getBytesEncoder(), 87)],
    ]),
    (value) => ({ ...value, discriminator: POSITION_V2_DISCRIMINATOR })
  );
}
...
export function getPositionV2Decoder(): FixedSizeDecoder<PositionV2> {
  return getStructDecoder([
    ...
    ['liquidityShares', getArrayDecoder(getU128Decoder(), { size: 70 })],
    ...
    ['reserved', fixDecoderSize(getBytesDecoder(), 87)],
  ]);
}

export function getPositionV2Codec(): FixedSizeCodec<
  PositionV2Args,
  PositionV2
> {
...
export function decodePositionV2<TAddress extends string = string>(
  encodedAccount: EncodedAccount<TAddress>
): Account<PositionV2, TAddress>;
export function decodePositionV2<TAddress extends string = string>(
  encodedAccount: MaybeEncodedAccount<TAddress>
): MaybeAccount<PositionV2, TAddress>;
export function decodePositionV2<TAddress extends string = string>(
  encodedAccount: EncodedAccount<TAddress> | MaybeEncodedAccount<TAddress>
): Account<PositionV2, TAddress> | MaybeAccount<PositionV2, TAddress> {
  return decodeAccount(
    encodedAccount as MaybeEncodedAccount<TAddress>,
    getPositionV2Decoder()
  );
}
