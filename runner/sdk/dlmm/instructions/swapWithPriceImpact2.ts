...
export const SWAP_WITH_PRICE_IMPACT2_DISCRIMINATOR = new Uint8Array([
  74, 98, 192, 214, 177, 51, 75, 51,
]);

export function getSwapWithPriceImpact2DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    SWAP_WITH_PRICE_IMPACT2_DISCRIMINATOR
  );
}

export type SwapWithPriceImpact2Instruction<
...
export type SwapWithPriceImpact2InstructionData = {
...
export type SwapWithPriceImpact2InstructionDataArgs = {
  amountIn: number | bigint;
  activeId: OptionOrNullable<number>;
  maxPriceImpactBps: number;
  remainingAccountsInfo: RemainingAccountsInfoArgs;
};

export function getSwapWithPriceImpact2InstructionDataEncoder(): Encoder<SwapWithPriceImpact2InstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['amountIn', getU64Encoder()],
      ['activeId', getOptionEncoder(getI32Encoder())],
      ['maxPriceImpactBps', getU16Encoder()],
      ['remainingAccountsInfo', getRemainingAccountsInfoEncoder()],
    ]),
    (value) => ({
      ...value,
      discriminator: SWAP_WITH_PRICE_IMPACT2_DISCRIMINATOR,
    })
  );
}

export function getSwapWithPriceImpact2InstructionDataDecoder(): Decoder<SwapWithPriceImpact2InstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
    ['amountIn', getU64Decoder()],
    ['activeId', getOptionDecoder(getI32Decoder())],
    ['maxPriceImpactBps', getU16Decoder()],
    ['remainingAccountsInfo', getRemainingAccountsInfoDecoder()],
  ]);
}

export function getSwapWithPriceImpact2InstructionDataCodec(): Codec<
  SwapWithPriceImpact2InstructionDataArgs,
  SwapWithPriceImpact2InstructionData
> {
  return combineCodec(
    getSwapWithPriceImpact2InstructionDataEncoder(),
    getSwapWithPriceImpact2InstructionDataDecoder()
  );
}

export type SwapWithPriceImpact2Input<
...
> = {
  ...
  amountIn: SwapWithPriceImpact2InstructionDataArgs['amountIn'];
  activeId: SwapWithPriceImpact2InstructionDataArgs['activeId'];
  maxPriceImpactBps: SwapWithPriceImpact2InstructionDataArgs['maxPriceImpactBps'];
  remainingAccountsInfo: SwapWithPriceImpact2InstructionDataArgs['remainingAccountsInfo'];
};

export function getSwapWithPriceImpact2Instruction<
  TAccountLbPair extends string,
  TAccountBinArrayBitmapExtension extends string,
  TAccountReserveX extends string,
  TAccountReserveY extends string,
...
>(
  input: SwapWithPriceImpact2Input<
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountReserveX,
    TAccountReserveY,
...
> {
  ...
  return Object.freeze({
    ...
    data: getSwapWithPriceImpact2InstructionDataEncoder().encode(
      args as SwapWithPriceImpact2InstructionDataArgs
    ),
    programAddress,
  } as SwapWithPriceImpact2Instruction<
    TProgramAddress,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountReserveX,
...
export type ParsedSwapWithPriceImpact2Instruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: SwapWithPriceImpact2InstructionData;
};

export function parseSwapWithPriceImpact2Instruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedSwapWithPriceImpact2Instruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getSwapWithPriceImpact2InstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
