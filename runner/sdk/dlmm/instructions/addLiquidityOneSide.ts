...
export const ADD_LIQUIDITY_ONE_SIDE_DISCRIMINATOR = new Uint8Array([
  94, 155, 103, 151, 70, 95, 220, 165,
]);

export function getAddLiquidityOneSideDiscriminatorBytes() {
...
export type AddLiquidityOneSideInstructionData = {
...
export function getAddLiquidityOneSideInstructionDataEncoder(): Encoder<AddLiquidityOneSideInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: ADD_LIQUIDITY_ONE_SIDE_DISCRIMINATOR,
    })
  );
}
...
export function getAddLiquidityOneSideInstructionDataCodec(): Codec<
  AddLiquidityOneSideInstructionDataArgs,
  AddLiquidityOneSideInstructionData
> {
  return combineCodec(
    getAddLiquidityOneSideInstructionDataEncoder(),
    getAddLiquidityOneSideInstructionDataDecoder()
  );
}

export type AddLiquidityOneSideInput<
...
>(
  input: AddLiquidityOneSideInput<
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountUserToken,
...
> {
  ...
  return Object.freeze({
    ...
    data: getAddLiquidityOneSideInstructionDataEncoder().encode(
      args as AddLiquidityOneSideInstructionDataArgs
    ),
    programAddress,
  } as AddLiquidityOneSideInstruction<
    TProgramAddress,
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
...
export type ParsedAddLiquidityOneSideInstruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
export function parseAddLiquidityOneSideInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAddLiquidityOneSideInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAddLiquidityOneSideInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
