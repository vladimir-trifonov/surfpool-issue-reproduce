...
export const ADD_LIQUIDITY_ONE_SIDE_PRECISE_DISCRIMINATOR = new Uint8Array([
  161, 194, 103, 84, 171, 71, 250, 154,
]);

export function getAddLiquidityOneSidePreciseDiscriminatorBytes() {
...
export type AddLiquidityOneSidePreciseInstructionData = {
  discriminator: ReadonlyUint8Array;
  bins: Array<CompressedBinDepositAmount>;
  decompressMultiplier: bigint;
};

export type AddLiquidityOneSidePreciseInstructionDataArgs = {
...
export function getAddLiquidityOneSidePreciseInstructionDataEncoder(): Encoder<AddLiquidityOneSidePreciseInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: ADD_LIQUIDITY_ONE_SIDE_PRECISE_DISCRIMINATOR,
    })
  );
}
...
export function getAddLiquidityOneSidePreciseInstructionDataCodec(): Codec<
  AddLiquidityOneSidePreciseInstructionDataArgs,
  AddLiquidityOneSidePreciseInstructionData
> {
  return combineCodec(
    getAddLiquidityOneSidePreciseInstructionDataEncoder(),
    getAddLiquidityOneSidePreciseInstructionDataDecoder()
  );
}
...
export function getAddLiquidityOneSidePreciseInstruction<
  TAccountPosition extends string,
  TAccountLbPair extends string,
  TAccountBinArrayBitmapExtension extends string,
  TAccountUserToken extends string,
...
>(
  input: AddLiquidityOneSidePreciseInput<
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountUserToken,
...
> {
  ...
  return Object.freeze({
    ...
    data: getAddLiquidityOneSidePreciseInstructionDataEncoder().encode(
      args as AddLiquidityOneSidePreciseInstructionDataArgs
    ),
    programAddress,
  } as AddLiquidityOneSidePreciseInstruction<
    TProgramAddress,
    TAccountPosition,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
...
export type ParsedAddLiquidityOneSidePreciseInstruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
export function parseAddLiquidityOneSidePreciseInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedAddLiquidityOneSidePreciseInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAddLiquidityOneSidePreciseInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
