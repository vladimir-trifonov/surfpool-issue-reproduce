...
export const SWAP_WITH_PRICE_IMPACT_DISCRIMINATOR = new Uint8Array([
  56, 173, 230, 208, 173, 228, 156, 205,
]);

export function getSwapWithPriceImpactDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    SWAP_WITH_PRICE_IMPACT_DISCRIMINATOR
  );
}

export type SwapWithPriceImpactInstruction<
...
export type SwapWithPriceImpactInstructionData = {
...
export type SwapWithPriceImpactInstructionDataArgs = {
  amountIn: number | bigint;
  activeId: OptionOrNullable<number>;
  maxPriceImpactBps: number;
};

export function getSwapWithPriceImpactInstructionDataEncoder(): Encoder<SwapWithPriceImpactInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: SWAP_WITH_PRICE_IMPACT_DISCRIMINATOR,
    })
  );
}

export function getSwapWithPriceImpactInstructionDataDecoder(): Decoder<SwapWithPriceImpactInstructionData> {
...
export function getSwapWithPriceImpactInstructionDataCodec(): Codec<
  SwapWithPriceImpactInstructionDataArgs,
  SwapWithPriceImpactInstructionData
> {
  return combineCodec(
    getSwapWithPriceImpactInstructionDataEncoder(),
    getSwapWithPriceImpactInstructionDataDecoder()
  );
}

export type SwapWithPriceImpactInput<
...
> = {
  ...
  amountIn: SwapWithPriceImpactInstructionDataArgs['amountIn'];
  activeId: SwapWithPriceImpactInstructionDataArgs['activeId'];
  maxPriceImpactBps: SwapWithPriceImpactInstructionDataArgs['maxPriceImpactBps'];
};

export function getSwapWithPriceImpactInstruction<
  TAccountLbPair extends string,
  TAccountBinArrayBitmapExtension extends string,
  TAccountReserveX extends string,
  TAccountReserveY extends string,
...
>(
  input: SwapWithPriceImpactInput<
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountReserveX,
    TAccountReserveY,
...
> {
  ...
  return Object.freeze({
    ...
    data: getSwapWithPriceImpactInstructionDataEncoder().encode(
      args as SwapWithPriceImpactInstructionDataArgs
    ),
    programAddress,
  } as SwapWithPriceImpactInstruction<
    TProgramAddress,
    TAccountLbPair,
    TAccountBinArrayBitmapExtension,
    TAccountReserveX,
...
export type ParsedSwapWithPriceImpactInstruction<
  TProgram extends string = typeof LB_CLMM_PROGRAM_ADDRESS,
...
> = {
  ...
  data: SwapWithPriceImpactInstructionData;
};

export function parseSwapWithPriceImpactInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedSwapWithPriceImpactInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getSwapWithPriceImpactInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
