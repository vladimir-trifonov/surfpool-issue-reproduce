...
export const SWAP_BASE_INPUT_DISCRIMINATOR = new Uint8Array([
  143, 190, 90, 218, 196, 30, 51, 222,
]);

export function getSwapBaseInputDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    SWAP_BASE_INPUT_DISCRIMINATOR
  );
}

export type SwapBaseInputInstruction<
...
export type SwapBaseInputInstructionData = {
  discriminator: ReadonlyUint8Array;
  amountIn: bigint;
  minimumAmountOut: bigint;
};

export type SwapBaseInputInstructionDataArgs = {
...
export function getSwapBaseInputInstructionDataEncoder(): FixedSizeEncoder<SwapBaseInputInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: SWAP_BASE_INPUT_DISCRIMINATOR })
  );
}
...
export function getSwapBaseInputInstructionDataCodec(): FixedSizeCodec<
  SwapBaseInputInstructionDataArgs,
  SwapBaseInputInstructionData
> {
  return combineCodec(
    getSwapBaseInputInstructionDataEncoder(),
    getSwapBaseInputInstructionDataDecoder()
  );
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getSwapBaseInputInstructionDataEncoder().encode(
      args as SwapBaseInputInstructionDataArgs
    ),
    programAddress,
...
export type ParsedSwapBaseInputInstruction<
  TProgram extends string = typeof RAYDIUM_CP_SWAP_PROGRAM_ADDRESS,
...
export function parseSwapBaseInputInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedSwapBaseInputInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getSwapBaseInputInstructionDataDecoder().decode(instruction.data),
  };
}
